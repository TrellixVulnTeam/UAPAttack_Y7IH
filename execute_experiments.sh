...
python -W ignore run_attack.py --dataset cifar10 --network vgg16 --method badnet --gpus 6 &
python -W ignore run_attack.py --dataset cifar10 --network densenet121 --method badnet --gpus 6 &
